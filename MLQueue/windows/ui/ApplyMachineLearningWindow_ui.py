...
class Ui_ApplyMachineLearningWindow(object):
    def setupUi(self, ApplyMachineLearningWindow):
        ...
        icon12 = QIcon()
        icon12.addFile(u":/Icons/icons/Tango Icons/32x32/actions/format-indent-more.png", QSize(), QIcon.Normal, QIcon.Off)
        self.addToQueueButton.setIcon(icon12)
        ...
        self.menuSet_Font_Size.setGeometry(QRect(0, 0, 140, 122))
        icon13 = QIcon()
        icon13.addFile(u":/Icons/icons/apps/preferences-desktop-font.png", QSize(), QIcon.Normal, QIcon.Off)
        self.menuSet_Font_Size.setIcon(icon13)
        ...
        icon14 = QIcon()
        icon14.addFile(u":/Icons/icons/savesymbol.png", QSize(), QIcon.Normal, QIcon.Off)
        self.dockWidget.setWindowIcon(icon14)
        ...
        icon15 = QIcon()
        icon15.addFile(u":/Icons/icons/Tango Icons/32x32/actions/document-save.png", QSize(), QIcon.Normal, QIcon.Off)
        self.saveCurrentConfigBtn.setIcon(icon15)
        ...
        icon16 = QIcon()
        icon16.addFile(u":/Icons/icons/Tango Icons/32x32/actions/document-save-as.png", QSize(), QIcon.Normal, QIcon.Off)
        self.saveCurrentConfigAsBtn.setIcon(icon16)
        ...
        icon17 = QIcon()
        icon17.addFile(u":/Icons/icons/Tango Icons/32x32/actions/document-open.png", QSize(), QIcon.Normal, QIcon.Off)
