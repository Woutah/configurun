...
class Ui_ApplyMachineLearningWindow(object):
    def setupUi(self, ApplyMachineLearningWindow):
        ...
        icon14 = QIcon()
        icon14.addFile(u":/Icons/icons/apps/preferences-system-windows.png", QSize(), QIcon.Normal, QIcon.Off)
        self.menuMDI_Area.setIcon(icon14)
        ...
        icon15 = QIcon()
        icon15.addFile(u":/Icons/icons/savesymbol.png", QSize(), QIcon.Normal, QIcon.Off)
        self.dockWidget.setWindowIcon(icon15)
        ...
        icon16 = QIcon()
        icon16.addFile(u":/Icons/icons/actions/folder-new.png", QSize(), QIcon.Normal, QIcon.Off)
        self.OpenFileLocationBtn.setIcon(icon16)
        ...
        icon17 = QIcon()
        icon17.addFile(u":/Icons/icons/Tango Icons/32x32/categories/applications-development.png", QSize(), QIcon.Normal, QIcon.Off)
        self.dockWidget_3.setWindowIcon(icon17)
        ...
        icon18 = QIcon()
        icon18.addFile(u":/Icons/icons/Tango Icons/32x32/actions/edit-undo.png", QSize(), QIcon.Normal, QIcon.Off)
        self.UndoStack.setWindowIcon(icon18)
        ...
        self.menuview.addAction(self.actionReset_Splitters_2)
